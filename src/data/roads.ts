/* Road network — surveyed geometry. City segments are the OCE inventory target;
   national alignments are DPWH reference only and never drawn by the city. */
...
export const conditionOf = (pci: number): Condition => (pci >= 70 ? "Good" : pci >= 50 ? "Fair" : "Poor");
...
export const surfaceLadder = { opened: cityNetworkKm, concrete: kmBy("Concrete"), asphalt: kmBy("Asphalt"), gravel: kmBy("Gravel"), earth: kmBy("Earth") };
