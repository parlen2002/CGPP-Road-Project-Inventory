...
import { useAuth, ensureAuthReady } from "./state/authStore";
...
export default function App() {
  ...
  if (!ready) {
    return (
      <div className="grid h-screen place-items-center bg-paper-200">
        <p className="font-mono text-[11px] tracking-[0.22em] text-text-400 uppercase">Establishing secure session…</p>
      </div>
    );
  }
