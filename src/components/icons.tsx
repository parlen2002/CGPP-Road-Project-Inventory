...
export const IconBell = (p: P) => (
  <svg {...base(p)}>
    <path d="M6 10a6 6 0 0 1 12 0c0 3 .8 4.6 1.6 5.6.3.4 0 .9-.5.9H4.9c-.5 0-.8-.5-.5-.9C5.2 14.6 6 13 6 10Z" />
...
export const IconGear = (p: P) => (
  <svg {...base(p)}>
    ...
    <path d="M12 2.8l1.2 2.3 2.6-.6 1 2.4 2.6.7-.6 2.5 1.9 1.9-1.9 1.9.6 2.5-2.6.7-1 2.4-2.6-.6L12 21.2l-1.2-2.3-2.6.6-1-2.4-2.6-.7.6-2.5L3.3 12l1.9-1.9-.6-2.5 2.6-.7 1-2.4 2.6.6L12 2.8Z" />
  </svg>
);
