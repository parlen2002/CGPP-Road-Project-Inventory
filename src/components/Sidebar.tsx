...
import { IconMap, IconRoad, IconLayers, IconChart, IconStack, IconParcels, IconBarangay, IconStreet } from "./icons";
  ...
  return (
    <aside className="relative z-20 flex w-[62px] shrink-0 flex-col border-r-2 border-ink-700 bg-ink-900 lg:w-60">
      ...
      <div className="relative border-t border-ink-700 p-2.5 lg:p-3">
        ...
        <p className="mt-2.5 text-center font-mono text-[8.5px] tracking-[0.18em] text-paper-300/30 uppercase lg:text-left">OCE · PPC GIS UNIT</p>
      </div>
    </aside>
  );
}
